...
groups_1_empo2<-read.delim('group1_1_empo2.txt',header = T)
colnames(groups_1_empo2)[1]<-'samples'





nmds12_1<-merge(nmds12_1,groups_1_empo2,by='samples')
...
ggsave('nmds_envfit_1_empo2.pdf',width = 8,height = 6)
...
ggsave('nmds_without_envfit_1_empo2.pdf',width = 8,height = 6)