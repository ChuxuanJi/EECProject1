...
groups_1_shan<-read.delim('group1_1_ns_shan.txt',header = T)
...
ggsave('nmds_envfit_1_ns_shan.pdf',width = 8,height = 6)
...
ggsave('nmds_without_envfit_1_ns_shan.pdf',width = 8,height = 6)