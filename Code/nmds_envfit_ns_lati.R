...
groups_1_lati<-read.delim('group1_1_ns_lati.txt',header = T)
...
ggsave('nmds_envfit_1_ns_lati.pdf',width = 8,height = 6)
...
ggsave('nmds_without_envfit_1_ns_lati.pdf',width = 8,height = 6)